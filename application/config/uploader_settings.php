...
$config['img_path'] = '/uploader/image/'; // Relative to domain name
$config['upload_path'] = dirname(BASEPATH) . '/application/' . '/storage/upload_images/'; // Physical path. [Usually works fine like this]
